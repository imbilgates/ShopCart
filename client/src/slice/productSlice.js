...
const productSlice = createSlice({
  ...
  extraReducers: (builder) => {
    builder
      ...
      // Bulk extraReducers
      .addCase(createBulkProducts.pending, (state) => {
        state.isCreating = true;
      })
      .addCase(createBulkProducts.fulfilled, (state, action) => {
        state.isCreating = false;
        if (Array.isArray(action.payload)) {
          state.products = [...state.products, ...action.payload];
        }
      })
      .addCase(createBulkProducts.rejected, (state, action) => {
        state.isCreating = false;
...
export const createBulkProducts = createAsyncThunk(
  "products/createBulkProducts",
  async (productList, { rejectWithValue }) => {
    try {
      ...
      return data.data; // array of created products
    } catch (err) {
